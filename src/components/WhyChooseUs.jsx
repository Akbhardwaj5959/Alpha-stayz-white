...
export default function WhyChooseUs() {
  return (
    // CHANGE 1: 'bg-white' use kiya hai (White Background)
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">
             {/* CHANGE 2: 'text-black' taaki white background par dikhe */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              // CHANGE 3: White Cards with Shadow
              // - bg-white: Card ka background white
              // - shadow-lg: Card ko utha hua dikhane ke liye
              // - border-gray-100: Halka border structure ke liye
              // - hover:border-gold: Mouse le jaane par Gold border aayega
            ...
            >
              ...
              <div className="w-16 h-16 mx-auto mb-6 bg-gold/10 rounded-full flex items-center justify-center transition-all duration-300 group-hover:bg-gold group-hover:text-white">
